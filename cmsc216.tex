...
\newcommand{\me}{Maria Rita Sune Marques}
\newcommand{\thisterm}{Fall 2025}
\newcommand{\website}{http://cs.umd.edu/class/fall2025/cmsc216/}%chktex 8
\usepackage{ifpdf}
\ifpdf%
...
\draw (344.61,147.67) node  {\includegraphics[width=286.92pt,height=221.5pt]{img/qtspim1.png}};
...
\draw (340.35,234.38) node  {\includegraphics[width=404.03pt,height=80.06pt]{img/qtspim2.png}};
